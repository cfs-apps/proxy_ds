...
#define DS_DIAG_TLM_MID  CFE_PLATFORM_TLM_TOPICID_TO_MID(CFE_MISSION_DS_FILE_INFO_TLM_TOPICID) //bc
#define DS_COMP_TLM_MID  CFE_PLATFORM_TLM_TOPICID_TO_MID(CFE_MISSION_DS_FILE_COMP_TLM_TOPICID) //bc
